...
# Networking and Troubleshooting Guide
...
baseline is an open-source Mobile Device Management (MDM) agnostic tool designed to augment Zero Touch workflows for macOS. It allows for seamless configuration and deployment with recent updates featuring community-contributed enhancements.

## Features

### Progress Bar
- Monitor workflow progress efficiently with the newly added customizable progress bar.

### Per Line-Item Icons
- Enhance visual representation by incorporating icons for each line item, providing clarity in your workflows.
